...
function onBtnClick(e) {
    ...
    refs.othersIconOpen.style.display = refs.othersWrapper.classList.contains('is-open') ? 'none' : 'block';
    refs.othersIconClose.style.display = refs.othersWrapper.classList.contains('is-open') ? 'block' : 'none';
