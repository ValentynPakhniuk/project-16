...
// function addFavoriteMarkup() {
//     const markup = parsedNews
//         .map(news => {
//             const favNews = createFavoriteMarkup(
//                 news.imgUrl,
//                 news.category,
//                 news.title,
//                 news.text,
...
// function createFavoriteMarkup(ingUrl, category, title, text, date, readMoreLink, id) {
//       return `<li class="card fav-card data-target-id=${id}">
// //             <div class="block-photo">
// //             <img class="card-photo" src="${ingUrl}" alt="Сітка користувачів">
